...
export interface JBController3_0_1Interface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "reservedTokenBalanceOf(uint256)",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "reservedTokenBalanceOf(uint256,uint256)",
    values: [BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "totalOutstandingTokensOf(uint256,uint256)",
    values: [BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "totalOutstandingTokensOf(uint256)",
    values: [BigNumberish]
  ): string;
...
export interface JBController3_0_1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: JBController3_0_1Interface;
