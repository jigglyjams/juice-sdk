...
export interface JBETHPaymentTerminal3_1Interface extends utils.Interface {
  functions: {
  ...
  events: {
    ...
    "DistributeToPayoutSplit(uint256,uint256,uint256,tuple,uint256,uint256,address)": EventFragment;
    ...
    "PayoutReverted(uint256,tuple,uint256,bytes,address)": EventFragment;
...
export interface JBETHPaymentTerminal3_1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: JBETHPaymentTerminal3_1Interface;
  ...
  filters: {
    ...
    "DistributeToPayoutSplit(uint256,uint256,uint256,tuple,uint256,uint256,address)"(
      projectId?: BigNumberish | null,
    ...
    "PayoutReverted(uint256,tuple,uint256,bytes,address)"(
      projectId?: BigNumberish | null,
      split?: null,
      amount?: null,
      reason?: null,
